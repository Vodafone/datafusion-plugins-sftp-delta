...
/**
 * This class generates public and private keys for a given user / password
 */
public class EncriptionPublicPrivateKeyGenerator {
    ...
    private static String privateKeyPassword = "12345";
    private static String identity = "dummyuser";
