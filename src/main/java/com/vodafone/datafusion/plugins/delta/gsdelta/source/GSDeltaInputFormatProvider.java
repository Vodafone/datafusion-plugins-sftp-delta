...
public class GSDeltaInputFormatProvider implements InputFormatProvider {
    private static final Gson gson = new GsonBuilder().create();

    private final PluginConfig config;
    private final Map<String, String> conf;

    public GSDeltaInputFormatProvider(PluginConfig config) {
        this.config = config;
    ...
    public String getInputFormatClassName() {
        return GSDeltaInputFormat.class.getName();
    }
